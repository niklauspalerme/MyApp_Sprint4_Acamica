    ...
    try {
        ...
        let data = await Order.findAll({
            ...
            include:[
                ...
                {model: Agenda, attributes: ['id','address']},
...
const updateOrderPaymentDB = async (id,PaymentMethodId)=>{
    ...
    try {
        ...
        console.log("Error en updateOrderPaymentD......", error);
    }
...
//11) Actualizamos el state de la orden
